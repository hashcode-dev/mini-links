      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 sm:px-16 xl:px-24">
        <div className="max-w-md w-full mx-auto">
          ...
          <div className="space-y-3 mb-8">
            <button className="w-full py-3 px-4 bg-surface-container-lowest dark:bg-navy-light border border-surface-container-high dark:border-slate-700 rounded-lg text-sm font-bold text-navy dark:text-white hover:bg-surface-container-low dark:hover:bg-slate-800 transition-all flex items-center justify-center gap-3">
